...
class HoVerNet(Net):
    ...
    def __init__(self, input_ch=3, nr_types=None, freeze=False, mode='original'):
        ...
        def create_decoder_branch(out_ch=2, ksize=5):
            module_list = [ 
                ...
                ("dense", DenseBlock(256, [1, ksize], [128, 32], 8, split=4)),  # 最终的out_channel = 512 = 256 + 32 * 8
            ...
            module_list = [ 
                ...
                ("dense", DenseBlock(128, [1, ksize], [128, 32], 4, split=4)),  # 最终的out_channel = 256 = 128 + 32 * 4
    ...
    def forward(self, imgs):
        ...
        for branch_name, branch_desc in self.decoder.items():
            u3 = self.upsample2x(d[-1]) + d[-2]  # 1024, x/4 + 1024, x/4
            u3 = branch_desc[0](u3)

            u2 = self.upsample2x(u3) + d[-3]  # 512, x/2 + 512, x/2
            u2 = branch_desc[1](u2)

            u1 = self.upsample2x(u2) + d[-4]  # 256, x + 256, x
            u1 = branch_desc[2](u1)  # out: 64, x

            u0 = branch_desc[3](u1)  # out: out_ch, x
