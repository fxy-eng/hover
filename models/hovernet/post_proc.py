...
def process(pred_map, nr_types=None, return_centroids=False):
    ...
    if return_centroids or nr_types is not None:
        ...
        for inst_id in inst_id_list:
            ...
            inst_image, inst_contour, inst_hierarchy = cv2.findContours(
            ...
            for contour in inst_contour:
                if contour.ndim == 3 and contour.shape[1] == 1:
                    # 如果轮廓确实包含一个封装维度，可以安全地去掉
                ...
                contour[:, 0] += inst_bbox[0][1]  # X
                contour[:, 1] += inst_bbox[0][0]  # Y
