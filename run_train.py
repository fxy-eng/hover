...
class TrainManager(Config):
    ...
    def view_dataset(self, mode="train"):
        ...
        save_root = f'datasets/training/with_classification/consep_with_augment'
        ...
        for batch_data in dataloader:
            ...
            ## batch_data 的一些info  classification=True
            # print(batch_data)
            # print(batch_data['img'].shape)  # [2, 270, 270, 3]
            # print(batch_data['hv_map'].shape)  # [2, 80, 80, 2]
            # print(batch_data['np_map'].shape)  # [2, 80, 80]
            # print(batch_data['tp_map'].shape)  # [2, 80, 80]
            # if i == 1:
            #     break

            viz = prep_func(batch_data, is_batch=True, **prep_kwargs)
            file_path = os.path.join(save_root, f'{i}.png')
            i += 1
            plt.imshow(viz)
