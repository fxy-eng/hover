...
class Config(object):
    ...
    def __init__(self):
        ...
        nr_type = 5  # number of nuclear types (including background)  # classification=True
        # nr_type = None    # number of nuclear types (including background)  #classification=False
        ...
        self.log_dir = f"logs/with_classification/{self.dataset_name}"  # where checkpoints will be saved

        # paths to training and validation patches
        self.train_dir_list = [
            "datasets/extracted_data/with_classification/consep/train/540x540_164x164"
        ]
        self.valid_dir_list = [
            "datasets/extracted_data/with_classification/consep/valid/540x540_164x164"
        ]
