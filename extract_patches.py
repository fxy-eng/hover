...
if __name__ == "__main__":
    ...
    dataset_name = "consep"
    save_root = f"datasets/extracted_data/with_classification"
    # ---------------------------extracted image saving path---------------------------------

    # a dictionary to specify where the dataset path should be
    dataset_info = {
        "train": {
            "img": (".png", "datasets/CoNSeP/Train/Images/"),
            "ann": (".mat", "datasets/CoNSeP/Train/Labels/"),
        },
        "valid": {
            "img": (".png", "datasets/CoNSeP/Test/Images/"),
            "ann": (".mat", "datasets/CoNSeP/Test/Labels/"),
        },
    }
